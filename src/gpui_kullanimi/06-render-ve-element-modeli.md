...
GPUI ve Zed'de iki kompozisyon deseni paralel çalışır: çizim zincirinde `Refineable`, settings ve tema yüklemesinde `MergeFrom`. İkisi de "varsayılan değerin üstüne adım adım üzerine yazma uygula" mantığını kullanır, ancak farklı yerlerde devreye girer.
